		...
		btnG.addActionListener(new ActionListener() {
			...
			Connection con =null;
				try {
					...
					JOptionPane.showMessageDialog(null, "Debe llenar todos los espacios", "ERROR", JOptionPane.ERROR_MESSAGE);//es para los espacios, pero también hace falta un mensaje para cuando no se ingresa el formato correcto
				}catch(Exception e1){
